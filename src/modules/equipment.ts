...
// #85: Rmapresourcetojob + the six RpreBuy*2 vars lived here. They were the private state of
// RpreBuy3/RpostBuy3/Requipcalc — the U2 gear buyer superseded by RautoEquip — and `--deny-warnings`
// surfaced them the instant those functions were deleted as unreachable. Nothing else read them.
