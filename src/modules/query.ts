...
export function getCorruptScale(a: string){return"attack"===a?mutations.Corruption.statScale(3):"health"===a?mutations.Corruption.statScale(10):void 0}
export function isBuildingInQueue(a: string){for(var c in game.global.buildingsQueue)if(game.global.buildingsQueue[c].includes(a))return!0}
