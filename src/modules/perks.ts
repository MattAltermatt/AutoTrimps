...
var preset_Zek299 = [16.8, 3, 1.9, 1.1, 1.2, 1, 17.1, 3, 105, 0.06, 0.8, 0, 0, 0]; // #22: append classy (index 13, default 0) — array was one short → undefined/NaN.
var preset_Zek399 = [135, 6.1, 18.5, 6.5, 2.5, 6, 17, 6.1, 28, 0.08, 1, 0, 0, 0]; // #22: append classy (index 13, default 0).
