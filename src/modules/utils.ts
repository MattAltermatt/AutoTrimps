...
export function serializeSettings60() {
...
export function serializeSettings550() {
...
export function message2(a: any, b: any, c: any, d: any) {
    ...
    if (game.options.menu.timestamps.enabled) a = (1 == game.options.menu.timestamps.enabled ? getCurrentTime() : updatePortalTimer(!0)) + " " + a;
...
export function filterMessage2(a: any) {
    var displayed;
    ...
    for (var f = 0; f < c.length; f++) (c[f] as any).style.display = displayed;
