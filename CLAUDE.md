...
- **Phase Bugs (#22) shipped** (2026-07-08) — an adversarial multi-agent review found 26 confirmed bugs,
  ...
  proven Phase-0 characterization harness (see Conventions). Next: **Phase 1** — `@ts-nocheck` → true-TS
  conversion (leaf-first: `calc`/`stance` pure-math), plus the pre-existing `other.ts:2316`
  missing-setting fix.
